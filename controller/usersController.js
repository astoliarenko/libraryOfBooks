// import {scryptHash, key} from "../cryptoMy";
const {scryptHash, key} = require("../cryptoMy");
...
exports.addNewUser = async (req, res) => {
	...
	// const sql = "INSERT INTO `users`(`login`, `password`, `role_id`)
	// VALUES('" + req.query.login + "', '" + req.query.password + "', '" + req.query.role_id + "')";
	// db.query(sql, (err, results) => {
	// 	if (err) console.log("ошибка", err);
	// 	else response.status(results, res);
	// });
